...
class Data extends \Magento\Framework\View\Element\Template
{
     ...
     * @return string
     */
    public function getCountryHtmlSelect($defValue = null, $name = 'country_id', $id = 'modal_dealer_country', $title = 'Country')
    {
    ...
    {
        $countryId = $this->getData('modal_dealer_country_id');
        if ($countryId === null) {
